          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                viewport={{ once: true }}
                className="bg-white rounded-3xl p-8 lg:p-10 shadow-xl border border-border hover:scale-[1.02] transition-transform"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {coreValues.map((value) => (
                <div
                  key={value.title}
                  className="bg-white rounded-2xl p-6 shadow-md border border-border hover:scale-[1.02] transition-transform"
                >
