...
function EventCard({
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="group bg-white rounded-2xl border border-border overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer flex flex-col h-full"
      onClick={onClick}
    >
      {/* Image */}
      <div className="relative h-44 bg-gradient-to-br from-primary/20 to-primary/5 overflow-hidden flex-shrink-0">
        ...
        {/* Date Badge */}
        <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 text-center shadow-md">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        {/* CTA */}
        <div className="flex items-center justify-center gap-2 text-sm font-semibold text-primary group-hover:text-white py-2.5 bg-primary/10 group-hover:bg-primary rounded-xl transition-colors">
